...
class LoginForm(FlaskForm):
    email_or_phone = StringField('Email or Phone Number', [
        validators.DataRequired(),
        validators.Length(min=5, max=128, message="Enter a valid email or phone number")
    ], render_kw={"placeholder": "Email or Phone Number"})
    password = PasswordField(u'Password', render_kw={"placeholder": "Password"})
